...
class SmartypeObject() {
    ...
    init {
        ...
        file.addImport("kotlinx.serialization.modules", "polymorphic")
    ...
    fun configureApi(
        ...
        val funSpec = FunSpec.builder("getSerializersModule")
    ...
    private fun addClassSerializers(funSpec: FunSpec.Builder, classPoints: Collection<TypeSpec>){
        classPoints.forEach { point ->
            funSpec.addCode("    subclass(%L::class, %L.serializer())\n", point.name, point.name)
        }
    }
    ...
    private fun addProperty(
        ...
        if (typeName == Number::class.asClassName()) {
            propertyBuilder.addAnnotation(Contextual::class)
        }
