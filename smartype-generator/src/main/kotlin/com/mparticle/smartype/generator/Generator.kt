...
class Init : CliktCommand(name="init", help = "Initialize a 'smartype.config.json' configuration file") {
    ...
    override fun run() {
        ...
        File("/Users/wpassidomo/documents/smartype/smartype.config.json").writeText(jsonData)
...
class Generate : CliktCommand(name="generate", help = "Generate Smartype Client libraries given a Smartype configuration file") {
    private val smartypeConfigFile by option(help="A configuration file generated by the init command")
        .file().default(File("/Users/wpassidomo/documents/smartype/smartype.config.json"))
